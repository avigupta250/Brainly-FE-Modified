  ...
  return (
    ...
    <div><FlipWordsDemo/></div>
      ...
      <div className="w-full  h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
        <button className="font-boldrounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
        <img height={"60px"} className={`mt-[38px] w-[80px] md:mt-28  md:w-[250px] transition duration-200 ${visible ? "opacity-1" : "opacity-50"}`}  src={Brain1}/>
        </button>
